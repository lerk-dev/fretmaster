export const TRANSLATIONS = {
                'zh-CN': {
                    ...
                    'stats_week': '本周',
                    'stats_today': '今天',
                    'stats_recent_records': '近期练习记录',
                    'stats_recent_empty': '暂无练习记录',
                    'stats_duration_sec': '秒',
                    'current_step': '当前步骤',
                    'chord_degrees': '和弦音级',
                    'random_key': '随机调性',
                    'scale_notes': '音阶音符',
                    ...
                    'chord_symbol_fine_grained': '和弦符号细粒度设置',
                    'chord_symbol_minor': '小调和弦符号',
                    'chord_symbol_m7b5': '半减七和弦符号',
                    'chord_symbol_7b9': '属七降九和弦符号',
                    'chord_symbol_7b9_scale': '7b9 和弦对应音阶',
                    'limitation_exercises': '限制练习',
                    'limit_fret_zone': '5 品区限制',
                    'limit_fret_zone_start': '品区起点',
                    'limit_fret_zone_size': '品区宽度',
                    'limit_octave_shift': '八度切换',
                    'limit_octave_mode': '八度方向',
...
'level_single_root': '1',
                    ...
                    'chord_6add9': '六加九和弦',
                    'chord_m6add9': '小六加九和弦',
                    'chord_diminished7': '减七和弦',
                    'chord_dominant9': '属九和弦',
                    'chord_major9': '大九和弦',
                    'chord_minor9': '小九和弦',
                    'chord_dominant7sharp9': '属七升九和弦',
                    ...
                    'stepwise_voice_leading': '级进声部连接',
                    'common_tone_voice_leading': '共同音声部连接',
                    'contrary_motion_voice_leading': '反向进行声部连接',
                    'parallel_motion_voice_leading': '平行进行声部连接',
                    ...
                    'mic_not_found': '未找到麦克风设备',
                    'mic_generic_error': '无法获取麦克风权限',
                    'fullscreen_exit_hint': '点击空白处或按 ESC 退出全屏',
                    'chord_structure_drag_hint': '拖动或用方向键移动面板',
                    'stats_sync_success': '成功同步 {count} 条本地备份数据',
                    'stats_no_local_data': '没有需要同步的本地数据',
                    'stats_sync_failed': '同步失败',
                    'stats_clear_confirm': '确定要清空所有练习记录吗？此操作不可恢复。',
                    'stats_clear_title': '清空确认',
                    'stats_clear_confirm_btn': '清空',
                    'stats_cancel': '取消',
                    'stats_cleared': '已清空所有练习记录',
                    'stats_clear_failed': '清空失败',
                    'error_boundary_title': '出现了一些问题',
                    'error_boundary_component': '{name} 组件出现问题',
                    'error_boundary_default': '应用发生了意外错误',
                    'error_boundary_retry': '重试',
                    'error_boundary_details': '查看详情',
                    'debug_panel_title': '调试面板',
                    'debug_panel_toggle': '折叠/展开调试面板',
                    ...
                    'theme_auto': '跟随系统',
                    'theme_style': '主题风格',
                    'theme_brightness': '明暗模式',
                    'theme_style_classic': '经典',
                    'theme_style_forest': '森林',
                    'theme_style_ocean': '海洋',
                    'theme_style_sunset': '日落',
                    'theme_style_monochrome': '墨黑',
                    'theme_style_rose': '玫瑰',
                    'theme_style_midnight': '午夜',
                    'theme_style_sand': '沙岩',
                    'theme_style_celadon': '青瓷',
                    'theme_style_lavender': '薰衣草',
                    'theme_style_carbon': '碳黑',
                    'theme_style_classic_desc': '暖象牙白 + 翠绿',
                    'theme_style_forest_desc': '暖沙米色 + 森林绿',
                    'theme_style_ocean_desc': '淡青雾色 + 深海蓝',
                    'theme_style_sunset_desc': '暖米黄 + 琥珀橙',
                    'theme_style_monochrome_desc': '纯灰阶极简',
                    'theme_style_rose_desc': '暖粉灰 + 玫红',
                    'theme_style_midnight_desc': '淡靛蓝 + 深蓝',
                    'theme_style_sand_desc': '暖灰褐 + 赭石',
                    'theme_style_celadon_desc': '青瓷色 + 深青绿',
                    'theme_style_lavender_desc': '淡紫雾 + 紫罗兰',
                    'theme_style_carbon_desc': '工业灰 + 钢蓝',
                    'general_sound': '声音',
                    ...
                    'level_dim_wh': '减音阶（全半）',
                    'level_dim_hw': '减音阶（半全）',
                    'level_desc_altered_dominant_flat9': '变化属和弦结构\n\n属和弦：♭9, 3, ♯9, 7\n\n适用于变化属和弦',
                    'level_desc_altered_dominant_sharp9': '变化属和弦结构\n\n属和弦：♯9, 3, ♭9, 7\n\n适用于变化属和弦',
                    'level_desc_altered_dominant_flat5': '变化属和弦结构\n\n属和弦：♭5, 3, ♯5, 7\n\n适用于变化属和弦',
                    'level_desc_altered_dominant_sharp5': '变化属和弦结构\n\n属和弦：♯5, 3, ♭5, 7\n\n适用于变化属和弦',
                    'level_desc_altered_dominant_full': '完整变化属和弦结构\n\n属和弦：♭9, 3, ♯9, ♭5, ♯5, 7',
                    'level_desc_altered_scale': '变化音阶\n\n包含所有变化音的属和弦音阶',
                    'level_desc_diminished_whole_half': '全半减音阶\n\n减七和弦的标准音阶',
                    'level_desc_diminished_half_whole': '半全减音阶\n\n属七降九和弦的音阶',
                    'level_group_altered': '变化属和弦结构',
                    'level_group_diminished': '减音阶',
                },
                'en': {
...
'level_single_root': '1',
                    ...
                    'theme_style_forest': 'Forest',
                    'theme_style_ocean': 'Ocean',
                    'theme_style_sunset': 'Sunset',
                    'theme_style_monochrome': 'Mono',
                    'theme_style_rose': 'Rose',
                    'theme_style_midnight': 'Midnight',
                    'theme_style_sand': 'Sand',
                    'theme_style_celadon': 'Celadon',
                    'theme_style_lavender': 'Lavender',
                    'theme_style_carbon': 'Carbon',
                    'theme_style_classic_desc': 'Ivory white + Emerald',
                    'theme_style_forest_desc': 'Warm sand + Forest green',
                    'theme_style_ocean_desc': 'Mist cyan + Deep blue',
                    'theme_style_sunset_desc': 'Warm cream + Amber',
                    'theme_style_monochrome_desc': 'Pure grayscale minimal',
                    'theme_style_rose_desc': 'Warm pink gray + Rose',
                    'theme_style_midnight_desc': 'Indigo mist + Deep blue',
                    'theme_style_sand_desc': 'Warm taupe + Ochre',
                    'theme_style_celadon_desc': 'Celadon + Deep teal',
                    'theme_style_lavender_desc': 'Purple mist + Violet',
                    'theme_style_carbon_desc': 'Industrial gray + Steel blue',
                    'general_sound': 'Sound',
                    ...
                    'caged_chord_practice': 'CAGED Chord Practice',
                    'caged_show_chord': 'Show Chord',
                    ...
                    'mic_not_found': 'No microphone device found',
                    'mic_generic_error': 'Unable to get microphone permission',
                    'fullscreen_exit_hint': 'Click anywhere or press ESC to exit fullscreen',
                    'chord_structure_drag_hint': 'Drag or use arrow keys to move panel',
                    'stats_sync_success': 'Synced {count} local backup records',
                    'stats_no_local_data': 'No local data to sync',
                    'stats_sync_failed': 'Sync failed',
                    'stats_clear_confirm': 'Are you sure to clear all practice records? This cannot be undone.',
                    'stats_clear_title': 'Confirm Clear',
                    'stats_clear_confirm_btn': 'Clear',
                    'stats_cancel': 'Cancel',
                    'stats_cleared': 'All practice records cleared',
                    'stats_clear_failed': 'Clear failed',
                    'error_boundary_title': 'Something went wrong',
                    'error_boundary_component': '{name} component encountered an issue',
                    'error_boundary_default': 'An unexpected error occurred',
                    'error_boundary_retry': 'Retry',
                    'error_boundary_details': 'View details',
                    'debug_panel_title': 'Debug Panel',
                    'debug_panel_toggle': 'Toggle debug panel',
                    'debug_panel_close': 'Close debug panel',
                    ...
                    'chord_symbol_fine_grained': 'Chord Symbol Fine-Grained',
                    'chord_symbol_minor': 'Minor Chord Symbol',
                    'chord_symbol_m7b5': 'Half-Diminished Symbol',
                    'chord_symbol_7b9': 'Dominant 7♭9 Symbol',
                    'chord_symbol_7b9_scale': '7b9 Chord Scale',
                    'limitation_exercises': 'Limitation Exercises',
                    'limit_fret_zone': '5-Fret Zone',
                    'limit_fret_zone_start': 'Zone Start Fret',
                    'limit_fret_zone_size': 'Zone Size',
                    'limit_octave_shift': 'Octave Shift',
                    'limit_octave_mode': 'Octave Direction',
                    ...
                    // Scale descriptions
                    'scale_major_desc': 'Major scale: W-W-H-W-W-W-H',
                    'scale_minor_desc': 'Natural minor scale: W-H-W-W-H-W-W',
                    'scale_dorian_desc': 'Dorian mode: 2nd major mode, minor with major 6th',
                    'scale_phrygian_desc': 'Phrygian mode: 3rd major mode, exotic with minor 2nd',
                    'scale_lydian_desc': 'Lydian mode: 4th major mode, dreamy with augmented 4th',
                    'scale_mixolydian_desc': 'Mixolydian mode: 5th major mode, dominant 7th scale',
                    'scale_locrian_desc': 'Locrian mode: 7th major mode, half-diminished scale',
                    'scale_harmonic_minor_desc': 'Harmonic minor: natural minor with raised 7th',
                    'scale_melodic_minor_desc': 'Melodic minor: raised 6th and 7th ascending',
                    'scale_pentatonic_major_desc': 'Major pentatonic: 1-2-3-5-6, rock and country',
                    'scale_pentatonic_minor_desc': 'Minor pentatonic: 1-b3-4-5-b7, blues and rock',
                    'scale_blues_desc': 'Blues scale: minor pentatonic with flat 5th',
                    // Chord type descriptions
                    'chord_major_desc': 'Major triad: root + major 3rd + perfect 5th (1-3-5)',
                    'chord_minor_desc': 'Minor triad: root + minor 3rd + perfect 5th (1-b3-5)',
                    'chord_dim_desc': 'Diminished triad: root + minor 3rd + diminished 5th (1-b3-b5)',
                    'chord_aug_desc': 'Augmented triad: root + major 3rd + augmented 5th (1-3-#5)',
                    'chord_7_desc': 'Dominant 7th: major triad + minor 7th (1-3-5-b7)',
                    'chord_maj7_desc': 'Major 7th: major triad + major 7th (1-3-5-7)',
                    'chord_m7_desc': 'Minor 7th: minor triad + minor 7th (1-b3-5-b7)',
                    'chord_m7b5_desc': 'Half-diminished: diminished triad + minor 7th (1-b3-b5-b7)',
                    'chord_dim7_desc': 'Diminished 7th: diminished triad + diminished 7th (1-b3-b5-bb7)',
                    'chord_sus2_desc': 'Suspended 2nd: root + major 2nd + perfect 5th (1-2-5)',
                    'chord_sus4_desc': 'Suspended 4th: root + perfect 4th + perfect 5th (1-4-5)',
                    'chord_9_desc': 'Dominant 9th: dominant 7th + major 9th (1-3-5-b7-9)',
                    'chord_maj9_desc': 'Major 9th: major 7th + major 9th (1-3-5-7-9)',
                    'chord_m9_desc': 'Minor 9th: minor 7th + major 9th (1-b3-5-b7-9)',
                    'chord_11_desc': 'Dominant 11th: dominant 9th + perfect 11th (1-3-5-b7-9-11)',
                    'chord_13_desc': 'Dominant 13th: dominant 11th + major 13th (1-3-5-b7-9-11-13)',
                    'chord_6_desc': 'Major 6th: major triad + major 6th (1-3-5-6)',
                    'chord_m6_desc': 'Minor 6th: minor triad + major 6th (1-b3-5-6)',
                    'chord_add9_desc': 'Added 9th: major triad + major 9th (1-3-5-9)',
                    'chord_madd9_desc': 'Minor added 9th: minor triad + major 9th (1-b3-5-9)',
                    // Practice mode descriptions
                    'level_root_desc': 'Single chord tone\n\nRoot only',
                    'level_3rd_desc': 'Single chord tone\n\n3rd only\n\nUse 2nd or 4th on sus chords',
                    'level_5th_desc': 'Single chord tone\n\n5th only\n\nNo altered 5th on dominant',
                    'level_7th_desc': 'Single chord tone\n\n7th only\n\nUse 6th or b7 on 6th/dim chords',
                    'level_root_3rd_desc': 'Two chord tones\n\nRoot and 3rd\n\nUse root and 4th on sus',
                    'level_root_5th_desc': 'Two chord tones\n\nRoot and 5th\n\nNo altered 5th on dominant',
                    'level_root_7th_desc': 'Two chord tones\n\nRoot and 7th\n\nUse 6th or b7 on 6th/dim',
                    'level_3rd_5th_desc': 'Two chord tones\n\n3rd and 5th\n\nUse 4th and 5th on sus',
                    'level_3rd_7th_desc': 'Two chord tones\n\n3rd and 7th\n\nUse 4th and 7th on sus',
                    'level_root_3rd_5th_desc': 'Three chord tones\n\nRoot, 3rd and 5th\n\nUse root, 4th and 5th on sus',
                    'level_root_3rd_7th_desc': 'Three chord tones\n\nRoot, 3rd and 7th\n\nUse root, 4th and 7th on sus',
                    'level_3rd_5th_7th_desc': 'Three chord tones\n\n3rd, 5th and 7th',
                    'level_root_3rd_5th_random_desc': 'Three chord tones\n\nRandom inversion\n\nRoot-3rd-5th or 3rd-5th-Root or 5th-Root-3rd',
                    'level_root_3rd_5th_7th_desc': 'Four chord tones\n\nRoot, 3rd, 5th and 7th',
                    'level_3rd_5th_7th_root_desc': 'Four chord tones\n\n3rd, 5th, 7th, Root\n\n1st inversion',
                    'level_5th_7th_root_3rd_desc': 'Four chord tones\n\n5th, 7th, Root, 3rd\n\n2nd inversion',
                    'level_7th_root_3rd_5th_desc': 'Four chord tones\n\n7th, Root, 3rd, 5th\n\n3rd inversion',
                    'level_root_3rd_5th_7th_random_desc': 'Four chord tones\n\nRandom inversion\n\nAll four inversions randomly',
                    'level_root_3rd_5th_7th_root_desc': 'Four chord tones\n\nRoot, 3rd, 5th, 7th, Root\n\nExtended exercise',
                    'level_3rd_5th_7th_root_3rd_desc': 'Four chord tones\n\n3rd, 5th, 7th, Root, 3rd\n\n1st inversion extended',
                    'level_5th_7th_root_3rd_5th_desc': 'Four chord tones\n\n5th, 7th, Root, 3rd, 5th\n\n2nd inversion extended',
                    'level_7th_root_3rd_5th_7th_desc': 'Four chord tones\n\n7th, Root, 3rd, 5th, 7th\n\n3rd inversion extended',
                    'level_melodic_1_desc': 'Melodic structure - Root to 5th\n\nMajor/Dom: 1-2-3-5\nMinor: 1-3-4-5\nSus: 1-2-4-5',
                    'level_melodic_2_desc': 'Melodic structure - Root to 5th variation\n\nMajor/Dom: 2-1-5-3\nMinor: 3-1-5-4',
                    'level_melodic_3_desc': 'Melodic structure - 5th to Root\n\nMajor/Dom: 3-5-2-1\nMinor: 4-5-3-1',
                    'level_melodic_4_desc': 'Melodic structure - Root to 5th\n\nMajor/Dom: 5-1-2-3\nMinor: 5-1-3-4',
                    'level_melodic_5_desc': 'Melodic structure - Random inversion\n\nRandom inversion of 1-2-3-5',
                    'level_melodic_6_desc': 'Melodic structure - 5th to 9th\n\nMajor/Dom: 5-6-7-2\nMinor: 5-7-1-2',
                    'level_melodic_7_desc': 'Melodic structure - 5th to 9th variation\n\nMajor/Dom: 6-5-2-7\nMinor: 7-5-2-1',
                    'level_melodic_8_desc': 'Melodic structure - 5th to 9th\n\nMajor/Dom: 7-2-6-5\nMinor: 1-2-7-5',
                    'level_melodic_9_desc': 'Melodic structure - 5th to 9th\n\nMajor/Dom: 2-7-6-5\nMinor: 2-1-7-5',
                    'level_melodic_10_desc': 'Melodic structure - Random inversion\n\nRandom inversion of 5-6-7-2',
                    'level_voice_led_1_desc': 'Voice Led\n\nMinor/Dom/Major: 3-2-1-7\nSus: 4-2-1-7\nDim: 3-2-1-6',
                    'level_voice_led_2_desc': 'Voice Led variation\n\nMinor: 3-2-1-7\nDom: 3-5-7-2\nMajor: 5-1-2-3',
                    'level_voice_led_3_desc': 'Voice Led chordal\n\nMinor: 1-3-5-7\nDom/Major: 3-2-1-7',
                    'level_voice_led_4_desc': 'Voice Led mixed\n\nMinor: 1-3-5-7\nDom: 3-5-7-2\nMajor: 3-2-1-7',
                    'level_voice_led_5_desc': 'Voice Led advanced\n\nMinor: 5-3-1-7\nDom: 3-5-7-2\nMajor: 3-2-1-7',
                    'level_suspended_2_desc': 'Suspended structure\n\nSus2 resolution: 2-3-1\n\nSus2 resolves to 3rd then root',
                    'level_suspended_4_desc': 'Suspended structure\n\nSus4 resolution: 4-3-1\n\nSus4 resolves to 3rd then root',
                    'level_chord_scale_root_desc': 'Chord scale\n\nStarting from root\n\nPlay one octave of chord scale',
                    'level_chord_scale_3rd_desc': 'Chord scale\n\nStarting from 3rd\n\nPlay one octave of chord scale',
                    'level_chord_scale_5th_desc': 'Chord scale\n\nStarting from 5th\n\nPlay one octave of chord scale',
                    'level_chord_scale_7th_desc': 'Chord scale\n\nStarting from 7th\n\nPlay one octave of chord scale',
                    'level_chord_scale_random_chord_desc': 'Chord scale\n\nStarting from random chord tone\n\nPlay one octave of chord scale',
                    'level_chord_scale_random_scale_desc': 'Chord scale\n\nStarting from random scale tone\n\nPlay one octave of chord scale',
                    'level_passing_note_root_desc': 'Passing note scale\n\nRoot to root\n\nChord scale with passing notes, chord tones on strong beats',
                    'level_passing_note_3rd_desc': 'Passing note scale\n\n3rd to 3rd\n\nChord scale with passing notes',
                    'level_passing_note_5th_desc': 'Passing note scale\n\n5th to 5th\n\nChord scale with passing notes',
                    'level_passing_note_67_desc': 'Passing note scale\n\n6th to 6th or 7th to 7th\n\nBased on harmony',
                    'level_passing_note_random_desc': 'Passing note scale\n\nStarting from random chord tone\n\nChord scale with passing notes',
                    ...
                    'stats_recent_records': 'Recent Records',
                    'stats_recent_empty': 'No practice records yet',
                    'stats_duration_sec': 'sec',
                    ...
                    'level_desc_altered_dominant_flat9': 'Altered dominant structures\n\n♭9, 3, ♯9, 7 on dominant chords',
                    'level_desc_altered_dominant_sharp9': 'Altered dominant structures\n\n♯9, 3, ♭9, 7 on dominant chords',
                    'level_desc_altered_dominant_flat5': 'Altered dominant structures\n\n♭5, 3, ♯5, 7 on dominant chords',
                    'level_desc_altered_dominant_sharp5': 'Altered dominant structures\n\n♯5, 3, ♭5, 7 on dominant chords',
                    'level_desc_altered_dominant_full': 'Full altered dominant structures\n\n♭9, 3, ♯9, ♭5, ♯5, 7',
                    'level_desc_altered_scale': 'Altered scale\n\nDominant chord scale with all alterations',
                    'level_desc_diminished_whole_half': 'Whole-Half diminished scale\n\nStandard scale for diminished 7th chords',
                    'level_desc_diminished_half_whole': 'Half-Whole diminished scale\n\nScale for dominant 7♭9 chords',
                    'level_group_altered': 'Altered Dominant Structures',
                    'level_group_diminished': 'Diminished Scales',
                }
            }
